...
export default [
  {
    ...
    emailSettings: {
      ...
      updatesFromAR: {
        newsAboutARProductsAndFeatureUpdates: false,
        tipsOnGettingMoreOutOfKeen: false,
        thingsYouMissedSindeYouLastLoggedIntoKeen: true,
        newsAboutAKSOnPartnerProductsAndOtherServices: true,
        tipsOnAKSBusinessProducts: true,
      },
    },
    communication: {
      email: true,
  ...
  },
  {
    ...
    firstname: "Megan",
    lastname: "Fox",
    occupation: "Deputy Head of AR in New York office",
    companyName: "AR",
    phone: "456669067891",
    language: "en",
    timeZone: "International Date Line West",
